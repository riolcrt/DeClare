...
class DeClareDataset(Dataset):
    ...
    def _build_source_vocabularies(self):
        ...
        # taking care of unknown sources
        self.claim_unk_index = len(self.claim_source_vocab)
        self.article_unk_index = len(self.article_source_vocab)
        self.claim_source_vocab['unk'] = self.claim_unk_index
